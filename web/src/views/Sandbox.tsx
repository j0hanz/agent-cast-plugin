  ...
  return (
    <Main topbar={top}>
      <div className={ui.dhead}>
        <h1>Live sandbox</h1>
        <span className={`${ui.pill} ${ui.live}`}>Running</span>
        <div className="grow" />
        <Seg
          ...
          <Panel title="Session">
            {SESSION.length ? (
              ...
              <EmptyState
                ...
                description="The session hasn't started or no data was captured."
              />
            )}
          </Panel>
          <Panel title="Live log" className={ui.clip}>
            {LOG.length ? (
              ...
              <EmptyState
                ...
                description="Nothing has happened in this session yet."
              />
            )}
          </Panel>
        </div>
